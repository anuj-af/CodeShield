...
import { Play, Shield, Target, BarChart2, MessageSquare,Trophy } from 'lucide-react'
...
export default function Dashboard({ onScan, isScanning, vulnerabilityTypes, selectedVulnerabilities, onVulnerabilityChange, initialRepoUrl, setActivePage}: DashboardProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
            <CardTitle className="text-sm font-medium">Safe Code, Instantly</CardTitle>
            <Shield className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <Button className="w-full" variant="outline" onClick={()=>{setActivePage("secure-gen")}}>Generate Code</Button>
          </CardContent>
        </Card>
        {/* <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        ...
        {/* <Card>
         ...
         <Card>
          ...
          <CardContent>
            <Button className="w-full" variant="outline"onClick={()=>{setActivePage("collaboration")}}>Open team chat</Button>
          </CardContent>
        </Card>
         <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
            <CardTitle className="text-sm font-medium">Secure Coding Challenges</CardTitle>
            <Trophy className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <Button className="w-full" variant="outline" onClick={()=>{setActivePage("gamification")}}>Improve security skills</Button>
          </CardContent>
        </Card>
      </div>
      <div>
